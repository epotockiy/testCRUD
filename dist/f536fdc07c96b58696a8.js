...
/***/ function(module, exports) {
	...
	*/
	...
	function returnTemplate(){
	        ...
	        document.body.appendChild(doc.getElementById('home').cloneNode(true));
	}
	ko.components.register('home', {
	    viewModel: class Home {
	        constructor(){
	            this.a = ko.observable("return");
	        }
	    },
	    template: '<link rel="import" href="../templates/home.html"> <script>returnTemplate()</script>'
	})
